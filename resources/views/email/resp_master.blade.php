                                                          ...
                                                          <td style="text-align: left; font-family: Arial, Helvetica, sans-serif; font-size: 14px; padding: 15px 30px; font-weight: bold; border-collapse: separate;" class="bmeButtonText">
                                                            <span style="font-family: 'Courier New', Courier; font-size: 14px; color: rgb(66, 66, 66);">
                                                              <p style="color: rgb(66, 66, 66);">
                                                                Para: {!! $usuario[0]->nombres !!} {!! $usuario[0]->apellidos !!}.
                                                              </p>
                                                              <p style="color: rgb(66, 66, 66); text-align: justify;">
                                                                Se notifica que el remitente {!! $remitente[0]->nombres !!} {!! $remitente[0]->apellidos !!} identificado con el número de cedula {!! $remitente[0]->num_identificacion !!} ha contestado el PQRS N° {!! $pqrs !!}, por favor revisa la plataforma para dar una pronta respuesta a esta solicitud.
                                                                <br><br>
                                                                En caso tal de que se haya dado un visto bueno por parte del remitente, no es necesario dar una respuesta y se dará por cerrado este radicado. 
                                                              </p>
                                                            </span>
                                                          </td>
                                                        </tr>
                                                                                  ...
                                                                                  <tr>
                                                                                    <td style="border-radius: 0px; border: 3px solid rgb(0, 174, 84); text-align: center; font-family: Arial, Helvetica, sans-serif; font-size: 14px; padding: 15px 30px; font-weight: bold; border-collapse: separate; background-color: rgb(0, 174, 84);" class="bmeButtonText">
                                                                                      <span style="font-family: 'Courier New', Courier; font-size: 14px; color: rgb(255, 255, 255);">    
                                                                                        <a href="https://www.coopserp.com/pqrs/consultar" style="color: rgb(255, 255, 255); text-decoration: none;" target="_blank">VER RESPUESTA</a>
                                                                                      </span>
                                                                                    </td>
                                                                                  </tr>
                                                                                </tbody>    
                                                        ...
                                                        <tr>
                                                          <td valign="top" align="left" name="tblCell" style="padding: 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" class="tblCell">
                                                            <div style="line-height: 200%;">
                                                              <span style="font-size: 14px; font-family: 'Courier New', Courier; color: #fff; line-height: 200%;">NOTA: No dar respuesta por este medio, debe ser directamente en la plataforma PQRS Coopserp.
                                                              </span>
                                                            </div>
                                                          </td>
                                                        </tr>
