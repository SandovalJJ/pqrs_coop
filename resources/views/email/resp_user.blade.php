                                                          ...
                                                          <td style="text-align: left; font-family: Arial, Helvetica, sans-serif; font-size: 14px; padding: 15px 30px; font-weight: bold; border-collapse: separate;" class="bmeButtonText">
                                                            <span style="font-family: 'Courier New', Courier; font-size: 14px; color: rgb(66, 66, 66);">
                                                              <p style="color: rgb(66, 66, 66);">
                                                                Hola {!! $usuario[0]->nombres !!} {!! $usuario[0]->apellidos !!}.
                                                              </p>
                                                              <p style="color: rgb(66, 66, 66); text-align: justify;">
                                                                Por medio de este correo te notificamos que tu PQRS con radicado N° {!! $pqrs !!} ha sido respondido, por favor revisa la plataforma dando clic en el siguiente botón para que puedas ver los detalles.
                                                              </p>
                                                            </span>
                                                          </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                          <td valign="top" align="left" name="tblCell" style="padding: 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" class="tblCell">
                                                            <div style="line-height: 200%;">
                                                              <span style="font-size: 14px; font-family: 'Courier New', Courier; color: #fff; line-height: 200%;">Este correo tiene un plazo máximo de 24 horas para ser respondido en la plataforma, de lo contrario se asumirá que la respuesta dada fue de su agrado y se cerrara la conversación, gracias.
                                                              </span>
                                                            </div>
                                                          </td>
                                                        </tr>
