...
<title>Email Coopserp</title>
<link rel="shortcut icon" href="favicon.ico">

<style type="text/css">
  .bmeContainerRow{
    background: #046f7e !important;
    color: white;
  }
              ...
              <tr>
                <td name="bmeMainColumnParent" style="border: 0px none transparent; border-radius: 0px; border-collapse: separate;">       
                  <table name="bmeMainColumn" class="bmeHolder bmeMainColumn" style="max-width: 600px; border-radius: 0px; border-collapse: separate; border-spacing: 0px; overflow: visible;" cellspacing="0" cellpadding="0" border="0" align="center">
                    <tbody>
                      <tr>
                        <td width="100%" class="blk_container bmeHolder" name="bmePreHeader" valign="top" align="center" style="color: rgb(102, 102, 102); border: 0px none transparent; background-color: rgb(0, 174, 84);" bgcolor="#00ae54"></td>
                      </tr>
                      <tr>
                        <td width="100%" class="bmeHolder" valign="top" align="center" name="bmeMainContentParent" style="border: 0px none rgb(102, 102, 102); border-radius: 0px; border-collapse: separate; border-spacing: 0px; overflow: hidden;">  
                          <table name="bmeMainContent" style="border-radius: 0px; border-collapse: separate; border-spacing: 0px; border: 0px none transparent;" width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                            <tbody>
                              <tr>
                                <td width="100%" class="blk_container bmeHolder" name="bmeHeader" valign="top" align="center" style="color: rgb(56, 56, 56); border: 0px none transparent; background-color: rgb(0, 174, 84);" bgcolor="#00ae54">
                                                          ...
                                                          <td valign="top" align="left" name="tblCell" style="padding: 15px 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" class="tblCell">
                                                            <div style="line-height: 150%; text-align: right;">
                                                              <span style="font-size: 12px; font-family: 'Courier New', Courier; color: #ffffff; line-height: 150%;">
                                                                <span style="text-decoration: underline; line-height: 150%;">www.coopserp.com</span>
                                                              </span>
                                                            </div>
                                                          </td>
                                                        </tr>
                                              ...
                                              <tbody>
                                                <tr>
                                                  <td align="center" class="bmeImage" style="border-collapse: collapse; padding: 20px;">
                                                    <img src="https://www.coopserp.com/pq/img/logo2020.png" width="200" style="max-width: 200px; display: block; width: 150px;" alt="" border="0">
                                                  </td>
                                                </tr>
                                              </tbody>    
                                            </table>
                                                        ...
                                                        <tr>
                                                          <td valign="top" align="left" name="tblCell" style="padding: 10px 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" class="tblCell">
                                                            <div style="line-height: 150%; text-align: center;">
                                                              <span style="font-size: 26px; font-family: 'Courier New', Courier; color: #fff; line-height: 150%;">
                                                                <strong>PQRS COOPSERP</strong>
                                                              </span>    
                                                              <br>
                                                            </div>
                                                          </td>
                                                ...
                                                <tr>
                                                  <td align="left">    
                                                    <table cellspacing="0" cellpadding="0" border="0" class="bmeButton" align="left" style="border-collapse: separate;">
                                                      <tbody>
                                                        <tr>
                                                          <td style="text-align: left; font-family: Arial, Helvetica, sans-serif; font-size: 14px; padding: 15px 30px; font-weight: bold; border-collapse: separate;" class="bmeButtonText">
                                                            <span style="font-family: 'Courier New', Courier; font-size: 14px; color: rgb(66, 66, 66);">
                                                              ...
                                                              <p style="color: rgb(66, 66, 66); text-align: justify;">
                                                                Este correo te lo enviamos con el fin de mantenerte al tanto de tu proceso con el PQRS que acabas de radicar.
                                                                <br> 
                                                                Nuestro equipo está trabajando para darte una pronta respuesta.
                                                              </p>
                                                              <p style="color: rgb(66, 66, 66); text-align: justify;">
                                                                Recuerda que tu número de radicado es el <strong>{!! $radicado !!}</strong>, utilizalo junto con tu número de identificación registrado en la plataforma para poder consultar tu proceso ingresando al siguiente <a href="https://www.coopserp.com/pqrs/consultar">link<a>.
                                                              </p>
                                                              <p style="color: rgb(66, 66, 66); text-align: justify;">
                                                                Agradecemos que hagas uso de nuestras herramientas para expresarnos tus inquietudes.
                                                              </p>
                                                            </span>
                                                          </td>
                                                        </tr>
                                                                          ...
                                                                          <tr>
                                                                            <td align="center">    
                                                                              <table cellspacing="0" cellpadding="0" border="0" class="bmeButton" align="center" width="100%" style="border-collapse: separate;">
                                                                                <tbody>
                                                                                  <tr>
                                                                                    <td style="border-radius: 0px; border: 3px solid rgb(0, 174, 84); text-align: center; font-family: Arial, Helvetica, sans-serif; font-size: 14px; padding: 15px 30px; font-weight: bold; border-collapse: separate; background-color: rgb(0, 174, 84);" class="bmeButtonText">
                                                                                      <span style="font-family: 'Courier New', Courier; font-size: 14px; color: rgb(255, 255, 255);">    
                                                                                        <a href="https://www.coopserp.com/pqrs/consultar" style="color: rgb(255, 255, 255); text-decoration: none;" target="_blank">CONSULTAR PQRS</a>
                                                                                      </span>
                                                                                    </td>
                                                                                  </tr>
                                                                                </tbody>    
                                                        ...
                                                        <tr>
                                                          <td valign="top" align="left" name="tblCell" style="padding: 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" class="tblCell">
                                                            <div style="line-height: 200%;">
                                                              <span style="font-size: 14px; font-family: 'Courier New', Courier; color: #fff; line-height: 200%;">
                                                                Por favor no responder este correo, Gracias.
                                                              </span>
                                                            </div>
                                                          </td>
                                                        </tr>
